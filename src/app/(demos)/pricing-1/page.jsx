      ...
      <section className="relative py-20">
        <div className="container">
          <div className="mx-auto max-w-2xl sm:text-center">
            <span className="font-medium tracking-widest text-gray-400">
              our price
            </span>
            <h2 className="mt-7 text-3xl font-medium tracking-tight md:text-5xl">
              Price Plans
            </h2>
            ...
            <div className="flex flex-col overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700">
              ...
              <div className="p-10">
                ...
                <div className="flex justify-center">
                  <a href="#" className="rounded-md border border-purple-500 px-6 py-3 font-medium text-purple-500 transition-all duration-500 hover:bg-purple-500 hover:text-white">
                    Get Basic
                  </a>
                </div>
              </div>
                  ...
                  <div className="text-center">
                    <div className="flex flex-col">
                      ...
                      <div className="p-10">
                        ...
                        <div className="flex justify-center">
                          <a href="#" className="hover:bg-purple-500-800 rounded-md border border-purple-500 bg-purple-500 px-6 py-3 font-medium text-white">
                            Get Pro
                          </a>
                        </div>
                      </div>
